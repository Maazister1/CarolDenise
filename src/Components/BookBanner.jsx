...
// function BookBanner() {
//     return (
//         <section className="w-full bg-[#111111] text-white py-20 md:py-28 px-6 md:px-12 font-sans relative">
//             <div className="max-w-7xl mx-auto">
                
//                 {/* Top Mission Title & Main Heading */}
//                 <div className="max-w-3xl mb-20">
//                     <span className="text-[10px] sm:text-xs font-semibold uppercase tracking-[0.2em] text-white/60 mb-4 block">
//                         THE MISSION
//                     </span>
...
//                 {/* Divider Line */}
//                 <div className="w-full h-[1px] bg-white/15 mb-16"></div>
